...
export async function PUT(req, context) {
  try {
    ...
    const adminIndex = admins.findIndex((item) => item.id === id);
...
export async function DELETE(req, context) {
  try {
    ...
    const filteredAdmins = admins.filter((item) => item.id !== id);

    writeData("admins.json", filteredAdmins);
