  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8">
      <div className="max-w-3xl mx-auto bg-white rounded-3xl shadow-xl p-10">
        {/* Header */}
        <div className="mb-10">
          <h1 className="text-4xl font-bold text-gray-800">Add User</h1>
          <p className="text-gray-500 mt-2">Create new user</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          {/* Email Field with Validity Detection */}
          <div>
            <label className="block text-lg font-semibold text-gray-700 mb-3">
              Email *
            </label>
          ...
          {/* Password Field with Standard Requirements Pattern */}
          <div>
            <label className="block text-lg font-semibold text-gray-700 mb-3">
              Password *
            </label>
