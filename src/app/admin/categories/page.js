    ...
    <div className="min-h-screen bg-gray-100 p-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-500 mt-1">Manage all categories</p>
        </div>

        {/* Add Category */}
        {(admin?.role === "admin" || admin?.permissions?.categories?.create) && (
          <button
          ...
          <tbody>
            {paginatedCategories.map((category) => (
              ...
              >
                ...
                {/* Slug */}
                <td className="p-4 text-gray-700">{category.slug}</td>

                {/* Parent */}
                <td className="p-4 text-gray-700">
                  {category.parent
                    ? categories.find(
                        (item) => String(item.id) === String(category.parent)
                      )?.title || ""
                    : "Parent"}
                </td>
                ...
                <td className="p-4">
                  <div className="flex gap-3">
                    {/* Edit */}
                    {(admin?.role === "admin" || admin?.permissions?.categories?.edit) && (
                      <button
                        onClick={() =>
                    ...
                    {/* Delete */}
                    {(admin?.role === "admin" || admin?.permissions?.categories?.delete) && (
                      <button
