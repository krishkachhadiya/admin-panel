...
export default function EditProductPage() {
  ...
  async function handleUpdate(e) {
    ...
    try {
      ...
      const slugConflict = currentProducts.some(
        (item) => item.slug === formData.slug && String(item.id) !== String(params.id)
      );
    ...
    <div className="min-h-screen bg-gray-50 p-10">
      <div className="max-w-5xl mx-auto bg-white rounded-3xl shadow-xl p-10">
        ...
        <div className="mb-10">
          ...
          <p className="text-gray-500 mt-3 text-lg">Update product details</p>
        </div>
        ...
        <form onSubmit={handleUpdate} className="space-y-8">
          ...
          <div>
            ...
            {productExists && (
              <p className="text-red-500 text-sm mt-2">Product title already exists</p>
            )}
            <input
              required
              pattern=".*[A-Za-z].*"
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => {
                ...
                const exists = existingProducts.some(
                  (item) => String(item.id) !== String(params.id) && item.slug === slugValue
                );
