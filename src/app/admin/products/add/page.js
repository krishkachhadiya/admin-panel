  ...
  return (
    <div className="min-h-screen bg-gray-50 p-10">
      <div className="max-w-5xl mx-auto bg-white rounded-3xl shadow-xl p-10">
        {/* Header */}
        <div className="mb-10">
          <h1 className="text-5xl font-bold text-gray-900">Add Product</h1>
          <p className="text-gray-500 mt-3 text-lg">Create new product</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div>
            ...
            {productExists && (
              <p className="text-red-500 text-sm mt-2">Product already exists</p>
            )}
            <input
              required
              pattern=".*[A-Za-z].*"
